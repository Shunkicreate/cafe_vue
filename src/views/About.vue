    ...
    <div class="container">
      <div class="row justify-content-center">
        <div class="col-auto col-md-12">
          <h1 class="">手作りタルトと香り高い珈琲で、寛ぎのカフェタイムを</h1>
        </div>
        <!--写真横の文字ここから-->
        <div class="col-auto">
          <div class="row">
        ...
        <div class="col-12">
          <p>
            ...
            カフェでの時間をより楽しいものにしていただくべく、フラワーアレンジメントの講座や絵本の読み聞かせ、作品展やライブなど、さまざまなイベントも開催しております。スケジュールは<router-link :to="{ path: menu }">News</router-link
        ...
        <div class="col-12">
          <table class="table table-bordered">
            <tbody>
              <tr>
                <th scope="row" class="table-active" style="color: #3f5170">
                  住所
                </th>
                <th scope="col">
                  〒199-9999 或留県九寺楽市九寺楽町3-30-8（<router-link
                    to="/access"
                    >地図</router-link
                  >）
                </th>
              ...
              <tr>
                ...
                <td>
                  ご予約は、お電話もしくは<router-link to="/contact"
